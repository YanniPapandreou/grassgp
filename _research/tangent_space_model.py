...
# compute barycenter of data
anchor_point = compute_barycenter(Ws)
...
def train(cfg):
    ...
    print("HMC starting.")
    mcmc = run_inference(train_key, mcmc_config, grass_model, s_train, log_Ws_train)
