...
# %%
import time
from hydra_zen import instantiate, make_config, builds, launch, to_yaml, launch
import sys
...
# plt.xlabel(r"$\theta$")
# plt.legend()
# plt.savefig('images/karcher-mean-brute-force-loss-plot.png',dpi=300,bbox_inches='tight',facecolor="w")
...
# ax.legend()
# plt.tight_layout()
# fig.savefig('images/anchor-point-circle-rep.png',dpi=300,bbox_inches='tight',facecolor="w")
