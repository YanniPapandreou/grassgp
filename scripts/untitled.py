...
# %%
# # Complete model
def model(X, s, Ys, anchor_point, model_params, grass_jitter, reg_jitter, proj_jitter, grassmann_noise, reorthonormalize, b, params, know_reg_kernel_params: bool = True):
    ...
    scope(univariate_gp_model, prefix="reg", divider="-")(projected_data_all, vec(Ys), params, jitter=reg_jitter, know_kernel_params=know_reg_kernel_params)
